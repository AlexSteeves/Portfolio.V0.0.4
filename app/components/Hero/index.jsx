      ...
      <div className={styles.sticky} >
        ...
        <div className=" whitespace-nowrap flex flex-col justify-center text-center text-text overflow-hidden">
          <div className = "z-50 leading-[0.95] " >
            <p className = "uppercase my-0 py-0 font-bold" style = {{fontSize: 'calc(16px + 9vw)'}}>WELCOME, I'M</p>
            <p className = " uppercase my-0 font-bold" style = {{fontSize: 'calc(16px + 9vw)'}}>ALEX STEEVES</p>
          </div>
